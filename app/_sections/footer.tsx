  ...
  return (
    <footer className="bg-gray-900 text-white py-10">
      <div className="container mx-auto px-6 lg:px-20">
        {/* Top Section */}
        <div className="flex flex-col items-start md:flex-row md:justify-between md:items-center gap-6">
          {/* Brand & Mission */}
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-400 mt-2 max-w-md text-start max-sm:text-sm">
              We create world-class apps from scratch— and scale them.
            </p>
            <p className="text-gray-500 mt-0 max-w-md text-sm text-start max-sm:text-xs">
              Aka the next generation of apps that shape the future.
            </p>
          </div>

          <div className="border-t border-gray-700 my-1 w-full md:hidden max-sm:block"></div>

          {/* Quick Links */}
          <div className=" w-full flex flex-1 items-end justify-end">
            <div className="grid grid-cols-2 gap-6 text-sm justify-end">
              <div>
